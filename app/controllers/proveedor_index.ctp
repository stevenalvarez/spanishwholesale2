...
<li> <a href="<?php echo $this->webroot?>admin/calzados/index">Listado de Calzados</a></li>
</ul>
</div>
...
<tr>
    <td colspan="7">
        ...
        <div class="hrgreen" style="width: 700px;">
                ...
                <a class="hay" href="<?php echo $this->webroot?>admin/calsados/<?php echo $calsado['Calsado']['activado']=='1'?'desactivar':'activar'?>/<?php echo $calsado['Calsado']['id'] ?>">
                        <?php echo $calsado['Calsado']['activado']=='1'?'<label class="aprobado">Aprobado</label>':'<label class="pendiente">Pendiente</label>'; ?>
                </a>
...
<?php
	...
	'format' => __('P&aacute;guina %page% de %pages%', true)
	));
	?>
	<div class="paging">
