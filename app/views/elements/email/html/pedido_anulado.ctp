...
<p style="font-family: Arial; color: #2d2d2d; font-size: 19px;"> Su pedido ha sido anulado por el proveedor <?php echo $proveedor["Usuario"]["title"] ?>, para mas detalles revise su cuenta.&nbsp;</p>
