...
</td><td><input type="submit" style="float:left" value="BUSCAR" class="btn-admin-orange" />
<a style="display: inline-block; font-size: 11px; text-decoration: none; text-align: center; width: 64px;" href="<?php echo $this->webroot;?>admin/usuarios/proveedores" class="btn-admin-orange">LIMPIAR</a></td></tr>
</table>
</form>
</div>
...
<tr class="clear">
    <td colspan="7">
    <input type="button" class="btn-admin-green" value="Nuevo" onclick="window.location.href='<?php echo $this->webroot?>admin/usuarios/addproveedor'" />
    
    <div class="admin-buttons">
   
    <input type="button" id="call" class="btn-admin-lblue" value="SELECCIONAR" />
    <input type="button" id="uall" class="btn-admin-lblue" value="DESELECCIONAR" />
