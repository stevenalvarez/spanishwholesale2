...
<div id="admin-table">
<form method="post" action="<?php echo $this->webroot?>proveedor/usuarios/smailrespuesta/<?php echo $usuario['Usuario']['id']; ?>">
...
<input type="hidden" name="consulta_id" value="<?php echo $consulta_id; ?>" />
    ...
    <tr><td colspan="2"><input type="submit" class="btn-admin-green2" value="Enviar Respuesta" /> </td></tr>
