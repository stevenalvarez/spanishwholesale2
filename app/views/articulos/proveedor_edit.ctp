...
<li> <a href="<?php echo $this->webroot?>proveedor/articulos/add">Registro nueva categor&iacute;a de art&iacute;culos</a></li>
</ul>
</div>
    ...
    <div id="pedido">
        <div>
            ...
            <div style="float: right;">
                <a href="<?php echo $this->webroot?>proveedor/articulos/delete/<?php echo $this->data["Articulo"]["id"]?>" onclick="confirm('Esta seguro de eliminar??')">
...
<?php 
        ...
        <form method="post" action="<?echo $this->webroot?>proveedor/articulos/edit/<?php echo $this->data["Articulo"]["id"]?>" style="margin-top: 20px;">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3">
                    <input type="button" class="btn-admin-orange2" value="RESTABLECER VALORES POR DEFECTO" onclick="window.location.href=('<?php echo $this->webroot?>proveedor/articulos/edit/<?php echo $this->data["Articulo"]["id"]?>')"  /> 
