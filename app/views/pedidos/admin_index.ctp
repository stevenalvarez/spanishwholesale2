...
<table>
    ...
    <tr class="clear">
    <td colspan="3"><a style="display: inline-block;color:#fff; font-size: 11px; text-decoration: none; text-align: center; width: 64px;" href="<?php echo $this->webroot;?>admin/pedidos/index/direction:desc/sort:id" class="btn-admin-orange">LIMPIAR</a></td>
    </tr>
</table>
</div>
...
-->
    ...
    echo   !empty($prov) ? $prov[0]['usuarios']['title'] : "";
    ?>
    </td>
    <td>
