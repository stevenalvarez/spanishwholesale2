...
<script>
                ...
                action: '<?php echo $this->webroot?>admin/fotos/add',
...
<li> <a href="<?php echo $this->webroot?>admin/calsados/add">Registro de un nuevo art&iacute;culo</a></li>
</ul>
</div>
...
<input name="step" class="btn-admin-green2" value="A&Ntilde;ADIR CAJAS SURTIDAS" onclick="showw('add_cajas_surtidas')" type="submit">    
 ...
 <div class="body"> 
    <form action="<?php echo $this->webroot?>admin/surtidos/add" style="margin:0;" id="SurtidoAddForm" method="post" accept-charset="utf-8"><div style="display:none;"><input name="_method" value="POST" type="hidden"></div>	
    <input name="data[Surtido][calsado_id]" value="<?php echo $this->data["Calsado"]["id"]?>" id="SurtidoCalsadoId" type="hidden"/>        
            ...
            <div class="input text">
            <label for="SurtidoPrecioSurOferta">Precio par Oferta</label>
                <input class="validate[required]" name="data[Surtido][precio_sur_oferta]" style="width: 50px;" id="SurtidoPrecioSurOferta" type="text"> &euro;</div><input name="data[Surtido][tipo]" value="cajas_surtidas" id="SurtidoTipo" type="hidden"/>
            </div>
...
<div class="add_surtido" id="add_surtido_libre" style="display: none;">
 <div class="headd"><label>Surtido Libre</label> <input class="btn-admin-red" value="BORRAR" style="margin-left: 200px; margin-top: 17px; vertical-align: top;" onclick="hidee(this)" type="button"> </div>
     <div class="body"> 
            <form action="<?php echo $this->webroot?>admin/surtidos/add" style="margin:0;" id="SurtidoAddForm2" method="post" accept-charset="utf-8"><div style="display:none;"><input name="_method" value="POST" type="hidden"></div>	<input name="data[Surtido][calsado_id]" value="<?php echo $this->data["Calsado"]["id"]?>" id="SurtidoCalsadoId" type="hidden">        
                    <div class="input text">
                        <label>Tama&ntilde;os*</label>        
                    ...
                    <input class="validate[required]" name="data[Surtido][precio_sur]" style="width: 50px;" id="SurtidoPrecioPar" class="" type="text"> &euro;  
                    </div> 
...
-->                 
                    ...
                    <div style="display: none;">
                        ...
                        <input class="validate[required]" name="data[Surtido][precio_par_oferta]" style="width: 50px;" id="SurtidoPrecioParOferta" type="text"> &euro;</div>
                    </div>
                    <!--
...
function delete_foto(thiss)
{
    ...
    jQuery(function(){        
       ...
       $.ajax({
       type: "GET",
       url: "<?php echo $this->webroot?>admin/fotos/delete/"+foto_id,
...
function save_foto(thiss)
{
       ...
       $.ajax({
       type: "POST",
       url: "<?php echo $this->webroot?>admin/fotos/update/"+foto_id,
