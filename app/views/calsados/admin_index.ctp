...
<a style="display: inline-block; font-size: 11px; text-decoration: none; text-align: center; width: 64px;" href="<?php echo $this->webroot;?>admin/calsados/index" class="btn-admin-orange">LIMPIAR</a>
</td>
</tr>
</table>
</form>
...
<tr>
    <td colspan="7">
        ...
        <div class="hrgreen" style="width: 700px;">
                ...
                <a style="overflow: hidden; padding: 2px;" class="hay" 
                href="<?php echo $this->webroot?>admin/calsados/<?php echo $calsado['Calsado']['activado']=='1'?'desactivar':'activar'?>/<?php echo $calsado['Calsado']['id'] ?>">
