...
form .required {font-weight: normal;}
     ...
     .plantillas {height: 800px !important;}
...
<?php echo $this->Form->create('Plantilla'); ?>
		...
		<h2 style="float: none;">A&ntilde;adir Plantilla</h2>
    
      <div style="display: block ; overflow: hidden; ">
	<?php
    	echo $this->Form->input('nombre',array('label'=>'Nombre de la plantilla*','after'=>'  requerido'));
