...
<?php echo $this->Form->create('Consulta');?>
	<fieldset>
		<legend><?php __('Admin Edit Consulta'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Consulta.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Consulta.id'))); ?></li>
