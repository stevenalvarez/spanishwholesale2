...
<?php echo $this->Form->create('Surtido');?>
	<fieldset>
		<legend><?php __('Edit Surtido'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Surtido.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Surtido.id'))); ?></li>
